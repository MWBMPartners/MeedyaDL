...
| **GAMDL** | Apple Music download engine. Installed via `pip` into the bundled Python. | **2.9.1 – 3.5** | 3.5 | `src-tauri/tool-versions.toml` → `[gamdl]` |
...
### v1.x — Current (v0.53.1) <!-- x-release-please-version -->
