...
- **`tools/audit-checks/check_ipc_commands.py`** + **`check_codec_registry.py`** + **`README.md`** — zero-dependency Python cross-source validators, runnable locally. (Two when this landed; ten as of 2026-09-10; twelve as of 2026-09-24 — see [[project-audit-checks-inventory]].)
