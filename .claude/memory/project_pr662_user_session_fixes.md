...
5. **The user's predictive QA cycle.** Salem874 described what would happen *next* before it happened ("MeedyaDL will eventually start logging errors again") — and was right. When users describe an architectural symptom prospectively, take it as evidence for the next-deeper layer rather than waiting for proof.
