...
**Why:** Salem874 has been merging changes aggressively through April; tracking the version delta + remaining RC blockers helps frame "how close is v1.0?" conversations without re-querying GitHub. Two open RC blockers means v1.0 is feasible after #232 + #182 close.
