...
export default {
  ...
  rules: {
    ...
    /**
     * header-max-length -- Maximum allowed length of the PR title / commit
     * subject line. The inherited @commitlint/config-conventional default is
     * 100, which is too tight for the project's [[feedback_pr_squash_titles]]
     * convention: PR squash titles ship to end users as the release-notes
     * line via release-please, so they need to be descriptive enough to
     * stand alone. Multi-issue bumper-PR titles routinely run 110-150 chars
     * (e.g. v1.8.0's #819 was 116 chars before hand-trimming).
     *
     * 150 is a soft cap chosen to:
     *   - fit the longest realistic multi-issue title without trimming,
     *   - stay below the 160-char hard limit GitHub uses for issue/PR
     *     subjects in some UI surfaces,
     *   - keep the rule's primary purpose (catching unbounded titles)
     *     intact.
     *
     * Closes #825.
     *
     * @see https://commitlint.js.org/reference/rules#header-max-length
     */
