...
- **Pending:** split `download_queue.rs` into submodules; minor version bump; final open+closed issue sweep + thorough docs pass (README/CLAUDE.md/help + in-app HelpViewer + memory).
