...
1. **Codec/Source/Channel tags + Apple Music API metadata** (always-on) — 30+ freeform atoms per file. Uses ffprobe-based codec detection for accurate tagging when native priority mode is active (GAMDL >= 3.0)
