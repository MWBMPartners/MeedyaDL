...
const MOCK_SETTINGS: AppSettings = {
  ...
  gamdl_idle_timeout_minutes: 10,
  auto_start_queue: false,
  abort_queue_confirm: false,
  ...
  video_codec_fallback_chain: ['h264', 'h265'],
  ...
  playlist_folder_template: 'TestPlaylists/{playlist_artist}',
  ...
  remux_mode: 'mp4box',
  use_wrapper: true,
  auto_retry_without_wrapper: true,
